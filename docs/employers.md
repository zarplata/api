...
----------------|-----------------|-----------------------------------------------------------------
 ...
 url            | string          | url для получения полного описания работодателя (будет отсутствовать в информации по кросспостинговой вакансии)
 alternate_url  | string          | ссылка на описание работодателя на сайте (будет отсутствовать в информации по кросспостинговой вакансии)
 vacancies_url  | string          | url для получения поисковой выдачи с вакансиями данной компании (будет отсутствовать в информации по кросспостинговой вакансии)
