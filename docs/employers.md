...
с дополнительным указанием количества открытых вакансий.
 ...
 Имя            | Тип             | Описание
----------------|-----------------|-----------------------------------------------------------------
 id             | string или null | идентификатор работодателя (будет отсутствовать в информации по кросспостинговой вакансии)
 name           | string          | название работодателя
 url            | string или null | url для получения полного описания работодателя (будет отсутствовать в информации по кросспостинговой вакансии)
 alternate_url  | string или null | ссылка на описание работодателя на сайте (будет отсутствовать в информации по кросспостинговой вакансии)
 vacancies_url  | string или null | url для получения поисковой выдачи с вакансиями данной компании (будет отсутствовать в информации по кросспостинговой вакансии)
...
### Возможные дополнительные параметры
- Необязательный параметр `is_old_id=true` позволяет использовать старый идентификатор работодателя
