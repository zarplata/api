...
* [Поиск по вакансиям, похожим на вакансию](https://api.zarplata.ru/openapi/redoc#tag/Poisk-vakansij/paths/~1vacancies~1{vacancy_id}~1similar_vacancies/get)
...
> !! Данный метод доступен в [OpenAPI](https://api.zarplata.ru/openapi/redoc#tag/Poisk-vakansij/paths/~1vacancies~1{vacancy_id}~1similar_vacancies/get)
