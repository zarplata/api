...
gender | [object](#id-name-object) или null | Пол. Элемент справочника [gender](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1dictionaries/get).
area | [object](#id-name-url-object) или null | Город проживания. Элемент справочника [areas](areas.md).
metro | [object](#metro-object) или null | Ближайшая станция метро. Элемент справочника [metro](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1metro/get).
relocation | [object](#relocation-object) | Информация о возможности переезда в другой город.
business_trip_readiness | [object](#id-name-object) | Готовность к командировкам. Элемент справочника [business_trip_readiness](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1dictionaries/get).
...
employments | [array](#id-name-object) | Список подходящих соискателю типов занятостей. Элементы справочника [employment](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1dictionaries/get).
schedules | [array](#id-name-object) | Список подходящих соискателю графиков работы. Элементы справочника [schedule](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1dictionaries/get).
education | [object](#education-object) | Образование.
language | [array](#language-object) | Список языков, которыми владеет соискатель. Элементы справочника [languages](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1languages/get).
...
travel_time | [object](#id-name-object) | Желательное время в пути до работы. Элемент справочника [travel_time](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1dictionaries/get).
recommendation | [array](#recommendation-object) | Список рекомендаций. 
resume_locale | [object](#id-name-object) | Язык, на котором составлено резюме (локаль). Элемент справочника [локали резюме](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1locales~1resume/get).
...
hidden_fields | [array](#id-name-object) | [Список скрытых полей](#hidden-fields). Элемент справочника [resume_hidden_fields](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1dictionaries/get).
...
Имя | Тип | Описание
-----|-----|---------
type | [object](#id-name-object) | Готовность к переезду. Элемент справочника [relocation_type](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1dictionaries/get).
...
Имя | Тип | Описание
-----|-----|---------
type | [object](#id-name-object) | Тип контакта. Элемент справочника [preferred_contact_type](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1dictionaries/get).
...
Имя | Тип | Описание
-----|-----|---------
type | [object](#id-name-object) | Тип профиля. Элемент справочника [resume_contacts_site_type](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1dictionaries/get).
...
-----|-----|---------
amount | number | Сумма.
currency | string | Идентификатор [валюты](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1dictionaries/get).
...
level | [object](#id-name-object) | Уровень образования. Элемент справочника [education_level](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1dictionaries/get).
...
level | [object](#id-name-object) | Уровень знания языка. Элемент справочника [language_level](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1dictionaries/get).
...
industries | [array](#id-name-object) | Cписок отраслей компании. Элементы [справочника индустрий](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1industries/get).
...
Имя | Тип | Описание
-----|-----|---------
id | string | Категория водительских прав соискателя. Элемент справочника [тип водительских прав](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/paths/~1dictionaries/get).
...
comments | object | [комментарии к владельцу резюме](https://api.zarplata.ru/openapi/redoc#tag/Kommentarii-k-soiskatelyu/paths/~1applicant_comments~1%7Bapplicant_id%7D/get)
...
[подробной истории откликов/приглашений по данному резюме](https://api.zarplata.ru/openapi/redoc#tag/Otklikipriglasheniya-rabotodatelya/paths/~1resumes~1%7Bresume_id%7D~1negotiations_history/get).
...
[полной истории откликов/приглашений по резюме](https://api.zarplata.ru/openapi/redoc#tag/Otklikipriglasheniya-rabotodatelya/paths/~1resumes~1%7Bresume_id%7D~1negotiations_history/get) и различается лишь тем, что
