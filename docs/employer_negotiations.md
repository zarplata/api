...
currency_code | нет | Код валюты. Возможные значения: `currency` (ключ code) в [/dictionaries](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/operation/get-dictionaries
driver_license_type | нет | Категории водительских прав. Можно передать множественные значения. Возможные значения: `driver_license_types` в [/dictionaries](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/operation/get-dictionaries)
education | нет | Образование. Возможные значения: `education_level` в [/dictionaries](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/operation/get-dictionaries)
...
university | нет | Идентификатор [учебного заведения](https://github.com/zarplata/api/blob/main/docs_eng/suggests.md). Можно передать множественные значения.
...
Изменять [состояние отклика(state)](employer_negotiations.md#negotiations-list-item) для соискателя может быть полезным для 
