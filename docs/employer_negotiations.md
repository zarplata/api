...
* [Действия по отклику/приглашению (смена состояния)](https://api.zarplata.ru/openapi/redoc#tag/Otklikipriglasheniya-rabotodatelya/operation/put-negotiations-collection-to-next-state)
...
* [Отметить отклики прочитанными](https://api.zarplata.ru/openapi/redoc#tag/Otklikipriglasheniya-rabotodatelya/operation/post-negotiations-topics-read) 
...
[списке вакансий работодателя](https://api.zarplata.ru/openapi/redoc#tag/Upravlenie-vakansiyami/operation/get-active-vacancy-list), там же
...
[можно отключить](https://api.zarplata.ru/openapi/redoc#tag/Vakansii/operation/get-vacancy) (поле `allow_messages`).
...
* с помощью отдельного метода [отметить определенные отклики как прочитанные](https://api.zarplata.ru/openapi/redoc#tag/Otklikipriglasheniya-rabotodatelya/operation/post-negotiations-topics-read)
...
> !! Данный метод доступен в [OpenAPI](https://api.zarplata.ru/openapi/redoc#tag/Otklikipriglasheniya-rabotodatelya/operation/get-negotiations)
...
citizenship | нет | Страна желаемого гражданства. Можно передать множественные значения. Возможные значения можно посмотреть в [справочнике стран](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/operation/get-countries)
...
show_only_new_responses | нет | Показывать только новые отклики (то есть отклики, которые не были просмотрены). Только для коллекции "Все неразобранные" (`/response`)
show_only_with_vehicle | нет | Фильтровать по наличию автомобиля
show_only_new | нет | Показывает отклики, в которых есть новые сообщения. Для коллекций, **отличных от** "Все неразобранные" (`/response`)
...
test_result | обьект, null | Результат [теста](https://api.zarplata.ru/openapi/redoc#tag/Otklikipriglasheniya-rabotodatelya/operation/get-negotiation-test-results) прикрепленного к вакансии
...
source | строка | Источник отклика. Возможные значения NEGOTIATION, PHONE_CALL, CHAT, VR, AUTO_INVITE.
...
templates | список | Шаблоны писем. Содержит идентификатор шаблона и url для [получения текста по шаблону](https://api.zarplata.ru/openapi/redoc#tag/Otklikipriglasheniya-rabotodatelya/operation/get-mail-templates).
...
* `message` - сообщение, которое будет отправлено соискателю на электронную почту. Используйте [шаблоны](https://api.zarplata.ru/openapi/redoc#tag/Otklikipriglasheniya-rabotodatelya/operation/get-mail-templates) для получения текстов.
...
которое указывает на состояние переписки ([возможные значения](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/operation/get-dictionaries)), и `professional_roles`, 
содержащее список профессиональных ролей ([возможные значения](https://api.zarplata.ru/openapi/redoc#tag/Obshie-spravochniki/operation/get-professional-roles-dictionary)). 
...
> !! Данный метод доступен в [OpenAPI](https://api.zarplata.ru/openapi/redoc#tag/Otklikipriglasheniya-rabotodatelya/operation/send-negotiation-message)
...
Получить эту информацию можно в [списке вакансий работодателя](https://api.zarplata.ru/openapi/redoc#tag/Upravlenie-vakansiyami/operation/get-active-vacancy-list)
...
> !! Данный метод доступен в [OpenAPI](https://api.zarplata.ru/openapi/redoc#tag/Otklikipriglasheniya-rabotodatelya/operation/get-pref-negotiations-order)
