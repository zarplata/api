...
```
 ...
 [информации о текущем пользователе](https://api.zarplata.ru/openapi/redoc#tag/Informaciya-o-menedzhere/operation/get-current-user-info).
...
```json
{
    "employer_statistics": {
        ...
        "politeness": {
            ...
            "article_url": "https://hr.zarplata.ru/article/23734"
        }
    }
}
```
...
| politeness | object или null | [Объект `politeness`](#employer_politeness_field) или `null`, если индекс вежливости компании рассчитать нельзя, например,  пока нет ни одной вакансии или отклика |

<a name="employer_politeness_field"></a>
#### Объект `politeness` для компании

Содержит информацию об индексе вежливости компании. 
...
| politeness | object или null | [Объект `politeness`](#manager_politeness_field) или `null`, если индекс вежливости менеджера рассчитать нельзя, например, у него пока нет ни одной вакансии или отклика |

<a name="manager_politeness_field"></a>
#### Объект `politeness` для менеджера

Содержит информацию по индексу вежливости менеджера. 
