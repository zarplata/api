...
* [Подсказки по профессиональным ролям](#proff-roles)
  ...
  "items": [
    {
      ...
      "logo_urls": {
        "90": "https://hr.zarplata.ru/employer-logo/289055.png"
      }
    }
  ]
}
...
одной проф.области.
Флаг `accept_incomplete_resumes` указывает на возможность принимать отклики
неполным резюме, при совпадении профессиональной роли в резюме и вакансии.  
...
```json
{
  "items": [
    ...
    {
      "url": "https://api.zarplata.ru/areas/2019",
...
<a name="proff-roles"></a>
## Подсказки по проффесиональным ролям

Для того чтобы узнать список подходящих проффесиональных ролей, необходимо отправить
`GET` запрос на `/suggests/professional_roles` со следующими параметрами:
