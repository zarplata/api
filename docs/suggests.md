...
* [Подсказки по профессиональным ролям](https://api.zarplata.ru/openapi/redoc#tag/Spravochniki/paths/~1suggests~1professional_roles/get)
...
Для того, чтобы получить подсказку по должностям резюме, необходимо отправить `GET`
