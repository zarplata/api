...
4. [Публикация вакансии на основе черновика](https://api.zarplata.ru/openapi/redoc#tag/Chernoviki-vakansij/paths/~1vacancies~1drafts~1%7Bdraft_id%7D~1publish/post) - добавлен параметр `with_professional_roles`
